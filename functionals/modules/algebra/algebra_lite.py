...
def simplified(expr: str) -> Algebra:
    '''docstring'''
...
def sigma(i: int, n: int, expr: str) -> float:
...
# calculators:
    ...
    @equation
    def __mul__(self, expr: str) -> Algebra:
        '''Returns self * term'''
    ...
    @equation
    def __pow__(self, expt: int) -> Algebra:
        '''Returns self**expt'''
        prod = 1
...
# etcetra:
    ...
    def draw_graph(self, extent: range = None, f: type(sort) = None) -> None:
    ...
    def roots(self, *eqns: Algebra) -> list:
    ...
    def zeroes(self, *zero: float) -> list:
